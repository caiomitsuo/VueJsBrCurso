  ...
  <header class="header">
    ...
    <div class="flex items-center justify-between py-10">
      ...
      <div class="flex flex-col mt-28">
        ...
        Receba ideias,reclamações e feedbacks com um <br class="hidden lg:inline-block"> simples widget na página.</p>
        <div>
...
@media (min-width: 640px){
  .header-group{
    background-imagem: url('../../assets/images/blue_ballons.png');
